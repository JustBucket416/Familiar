...
fun logV(tag: String = TAG, message: String? = null, cause: Throwable? = null) =
    log(
        Level.VERBOSE,
        tag,
        message,
...
fun logD(tag: String = TAG, message: String? = null, cause: Throwable? = null) =
    log(
        Level.DEBUG,
        tag,
        message,
...
fun logI(tag: String = TAG, message: String? = null, cause: Throwable? = null) =
    log(
        Level.INFO,
        tag,
        message,
...
fun logW(tag: String = TAG, message: String? = null, cause: Throwable? = null) =
    log(
        Level.WARN,
        tag,
        message,
...
fun logE(tag: String = TAG, message: String? = null, cause: Throwable? = null) =
    log(
        Level.ERROR,
        tag,
        message,
...
fun logWTF(tag: String = TAG, message: String? = null, cause: Throwable? = null) =
    log(
        Level.WTF,
        tag,
        message,
